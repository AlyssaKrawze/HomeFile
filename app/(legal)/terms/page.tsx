        ...
        <div className="bg-white rounded-xl border border-[#C8BFB2] p-8 md:p-12">
          ...
          <div className="space-y-8 text-[#4b5563] text-[0.9375rem] leading-[1.7]">
            <section>
              ...
              <p className="mb-3">
                These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity (&ldquo;you&rdquo;), and TheHomePage, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.
              </p>
              <p>
            ...
            <section>
              ...
              <p>
                You agree to defend, indemnify, and hold TheHomePage harmless from any claims arising from your use of the Services, breach of these Legal Terms, or violation of any third-party rights.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                These Legal Terms constitute the entire agreement between you and TheHomePage. If any provision is found unenforceable, the remaining provisions remain in full effect.
              </p>
            </section>
