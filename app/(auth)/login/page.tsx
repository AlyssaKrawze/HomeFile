    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 flex-col justify-between p-12">
        <div className="flex items-center gap-3">
          ...
          <span className="text-white font-semibold text-xl">TheHomeFile</span>
        </div>
        <div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="flex items-center gap-3 mb-10 lg:hidden">
            ...
            <span className="text-[#2F3437] font-semibold text-xl">TheHomeFile</span>
          </div>

          <h1 className="text-3xl font-bold text-[#2F3437] mb-2">Welcome back</h1>
          <p className="text-slate-500 mb-8">Sign in to your TheHomeFile account</p>
