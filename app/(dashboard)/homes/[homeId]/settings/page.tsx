...
import { ChevronRight, Settings, Home, Trash2 } from 'lucide-react'
        ...
        <div className="bg-white rounded-2xl border border-red-200">
          ...
          <div className="p-6">
            <div className="flex items-center justify-between">
              ...
              <button className="flex items-center gap-1.5 bg-red-50 hover:bg-red-100 text-red-600 border border-red-200 text-sm font-medium px-3 py-2 rounded-lg transition-colors">
                <Trash2 size={14} />
                Delete
              </button>
            </div>
