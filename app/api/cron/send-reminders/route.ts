        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;">
          ...
          <tr>
            <td style="background-color:#5B6C8F;padding:20px 24px;border-radius:12px 12px 0 0;">
              <span style="color:#ffffff;font-size:18px;font-weight:600;letter-spacing:0.5px;">TheHomeFile</span>
            </td>
          </tr>
          <!-- Body -->
          <tr>
          ...
          <tr>
            <td style="padding:20px 24px;text-align:center;">
              <p style="margin:0;font-size:12px;color:#9ca3af;">
                ${homeName} &middot; Sent by TheHomeFile
              </p>
            </td>
          </tr>
        </table>
  ...
  for (const reminder of reminders) {
    try {
      ...
      await resend.emails.send({
        from: 'TheHomeFile <reminders@thehomepage.app>',
