...
export async function POST(
  ...
  const message = await client.messages.create({
    ...
    messages: [{
      role: 'user',
      content: `You are a data mapping assistant. The user uploaded a spreadsheet of home service vendors and contacts with unknown column names.
...
- email: email address
- category: type of vendor or service they provide (e.g. "Plumber", "Electrician", "Landscaper", "HVAC Technician", "Painter", "Contractor", "Cleaning Service", "Pool Service", "Pest Control", etc. — infer from context if possible, otherwise "")
- notes: any other useful info such as address, specialty, license number, hourly rate, availability, etc.
