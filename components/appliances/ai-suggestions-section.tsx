          ...
          <>
            ...
            {(!generated || suggestions.length === 0) && !loading && (
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium px-4 py-2.5 rounded-xl transition-colors"
              >
                <Sparkles size={15} />
            ...
            {visibleSuggestions.length > 0 && (
              <div className="flex flex-col gap-3">
                  ...
                  return (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="flex items-center gap-1 text-xs text-purple-600 mt-2"
                      >
                      ...
                      <button
                        ...
                        className="w-full mt-3 flex items-center justify-center gap-1.5 bg-white border border-purple-300 hover:bg-purple-600 hover:text-white hover:border-purple-600 text-purple-700 text-xs font-medium px-3 py-2 rounded-lg transition-all disabled:opacity-50"
                      >
                        {accepting === i ? (
                ...
                <button
                  onClick={generateSuggestions}
                  className="w-full flex items-center justify-center gap-1.5 text-xs text-slate-500 hover:text-purple-600 transition-colors py-1"
                >
                  <Sparkles size={11} />
